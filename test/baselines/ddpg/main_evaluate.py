...
def parse_args():
    ...
    parser.add_argument('--model-path', type=str, default="/home/drl/PycharmProjects/DeployedProjects/CR_CPG_RL/log_files/openai-2018-09-11-10-32-29-437979/trained_variables9.ckpt")
